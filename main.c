...
int home() {
  ...
  SetColor(2);
  gotoxy(70, 25);
  printf("© Projects By Md Ohidur Rahman\n");
  gotoxy(79, 26);
  printf("Student ID: 221002406");
  SetColor(45);
  gotoxy(59, 16);
  hswitch = getche();
  switch (hswitch) {
...
int edit_3(char id[40], char date[40]) {
  ...
  edit_file = fopen("AttendanceEdit.txt", "w");
  ...
  if (found == 0) {
    ...
    edit_file = fopen("AttendanceEdit.txt", "r");
    while (1) {
